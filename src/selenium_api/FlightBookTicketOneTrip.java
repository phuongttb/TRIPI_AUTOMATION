...
public class FlightBookTicketOneTrip {
	...
	@Test()
	@Parameters({ "flightfromairportv", "flighttoairportv", "flightcheckindatev" ,"selectagencyintbound" ,"LastName","FirstName" ,"Baggage","Gender","GenderContact","LastNameContact","FirstNameContact" ,"Email","phone"})
	public void TC_01_Validatesamedestination(String flightfromairportv, String flighttoairportv,
			String flightcheckindatev , String selectagencyintbound, String LastName ,String FirstName , String Baggage ,String Gender ,String GenderContact,String LastNameContact, String FirstNameContact, String Email, String phone) throws Exception {
